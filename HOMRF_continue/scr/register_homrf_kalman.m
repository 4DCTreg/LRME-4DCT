function [Knots_n_tot,Knots_n]=register_homrf_kalman(parameter,volmov,volfix,crop_v,init_size,pts_fix,pts_mov,Knots_n_pre,bszv)
...
%      neighbor=Get_Neighbor_6(griddim(1),griddim(2),griddim(3));
    % Get the unary term
    tic
    unary=Get_Data_Term_3D(volmov,volfix,griddim,O_trans_X,O_trans_Y,...
