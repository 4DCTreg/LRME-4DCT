function [pt_errs_phys, pts_moved_pix, TRE_phys, TREstd_phys, pts_moved_r] = DIR_movepoints_homrf(pts_mov_pix, ...
                        pts_fix_pix, Tr_phys, spc, resize, lu_orig)
    ...
    if resize
        ...
        pts_moved_pix=simple_move_points(pts_fix_pix, Tr_phys, lu_orig);
    end
