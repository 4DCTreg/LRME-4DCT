...
function unary_tot=Get_Data_Term_3D_MIND_filter(Mov_mind,Fix_mind,griddim,O_trans_X,O_trans_Y,O_trans_Z,labels,level,previous,quant,cur_grid_space)
...
Hsmooth=fspecial3_v1('gaussian',cur_grid_space); 
% N_node=cur_grid_space(1)*cur_grid_space(2)*cur_grid_space(3);
for R_index=1:R
